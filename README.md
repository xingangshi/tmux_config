...
```
$ cd ~
$ git clone https://github.com/xingangshi/tmux_config.git
...
```
$ git clone https://github.com/xingangshi/tmux_config.git "/path/to/oh-my-tmux"
...
[my own Vim configuration]: https://github.com/xingangshi/vim_installer
